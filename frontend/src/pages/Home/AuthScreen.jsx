    ...
    return (
        <div className='hero-bg relative'>
            ...
            <div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
                ...
                <form className='flex flex-col md:flex-row gap-4 w-1/2 cursor-pointer' onSubmit={handleFormSubmit}>
                    <input
                        type="email"
                        placeholder='Email'
            ...
            <div className='py-10 bg-black text-white'>
                <div className='flex max-w-6xl max-auto items-center justify-center flex-col-reverse md:flex-row
                px-4 md:px-2
                '>
                    {/*left side*/}
                    <div className='flex-1 relative'>
                    ...
                    <div className='flex-1 text-center md:text-left'>
                        ...
                        <p className='text-lg md:text-xl'>
                            Send kids on adventures with their favroite charaters in space made just for them-free
                            with you membership
                        </p>
                    </div>
                </div>
